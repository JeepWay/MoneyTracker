...
public class PanelCardAddIncomeUI extends JPanel {
	/**
	 * Declare GUI components
	 */
	public JPanel panelSeperationLine, panelInput;
	public JLabel lblTextAddIncome1, lblTextAddIncome2;
	public JLabel lblIconAddIncome;
	...
	public PanelCardAddIncomeUI() {
		...
		lblHyperlink.setIcon(new ImageIcon(PanelCardAddIncomeUI.class.getResource("/icon/question.png")));
		 ...
		 * Heading
		 */
		lblTextAddIncome1 = new JLabel("Add Income");
		lblTextAddIncome1.setFont(new Font("Times New Roman", Font.PLAIN, 30));
		lblTextAddIncome1.setBounds(20, 10, 172, 55);
		add(lblTextAddIncome1);
		
		lblTextAddIncome2 = new JLabel("create new income information");
		lblTextAddIncome2.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		lblTextAddIncome2.setForeground(Color.GRAY);
		lblTextAddIncome2.setBounds(200, 30, 210, 24);
		add(lblTextAddIncome2);
		...
		lblIconAddIncome = new JLabel("");
		lblIconAddIncome.setIcon(new ImageIcon(PanelCardAddIncomeUI.class.getResource("/icon/profits_icon.png")));
		lblIconAddIncome.setHorizontalAlignment(SwingConstants.CENTER);
		lblIconAddIncome.setBounds(581, 115, 450, 450);
		add(lblIconAddIncome);
		...
		boxCategory.setModel(new DefaultComboBoxModel<String>(RecordConstants.LISTINCOME));
		...
		btnCalendar.setIcon(new ImageIcon(PanelCardAddIncomeUI.class.getResource("/icon/calendar.png")));
